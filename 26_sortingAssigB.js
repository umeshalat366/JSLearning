...
class Employee {
  ...
  //sort the arrayemployees in ascending order of employee id and log employee details id, name, department
...
//arrayemployees in ascending order of employee dept and log id dept and company
arrayEmployees.sort((emp1, emp2) =>{
...
//sort the employee array in descending order of employee salary and log name,salary and company
arrayEmployees.sort((emp1, emp2) => {
